...
package body Prolog.Ada_Logic is
   ...
   begin
       if false
          ...
          or else (C.Head.Tag = Skelt and then C.Head.Anont) then
          raise Attr_Error;
   ...
   procedure Copy_Clause(C1 : Clause; C2 : out Clause; N : Integer;
                         F : Field_Type);
   ...
   procedure Copy(L1 : List_Of_Clauses; L2 : out List_Of_Clauses) is
   ...
   procedure Copy(L1 : List_Of_Lists; L2 : out List_Of_Lists) is
   begin
       L2 := L1; --  To be changed.
   end Copy;
               
   procedure Append(C : Clause; L : in out List_Of_Clauses) is
       Ptr : Clause_List;
   begin
   ...
   procedure Append(C : List_Of_Clauses; L : in out List_Of_Lists) is
       Ptr1 : Integer_List;
       Ptr2 : List_List;
   begin
   ...
   procedure Append(C : Clause; L : in out List_Of_Sons) is
   begin
       C.Dbase := -1;
   ...
   begin
       if L.List = null then
           ...
           case C.Typ is
               when Commac =>
                   Ptr.Next := 
                          new Clause_List_Record'(Clause(Makeclause(
                                                  C.Head,0)),null);
               when Chainc =>
                   Ptr.Next := new Clause_List_Record'(Clause(Makeclause(
                                                C.Head,C.The_Body,0)),null);
               when Madec =>
   ...
   procedure Append(L1 : in out List_Of_Clauses; L2 : List_Of_Clauses) is
       Ptr : Clause_List;
   ...
   procedure Append(L1 : in out List_Of_Sons; L2 : List_Of_Sons) is
       Ptr : Term;
   begin
       if L1.List = null then
           L1 := L2;
   ...
   procedure Append(L1 : in out List_Of_Lists; L2 : List_Of_Lists) is
       Ptr1 : Integer_List;
       Ptr2 : List_List;
   begin
       if L1.List = null then
   ...
   procedure Delete_Item(L : in out List_Of_Sons; N : Positive) is
       Ptr : Term;
       I : Integer := 2;
   begin
       if L.List = null then
...
--                WRITEOUT(PTR.VALUE.THE_BODY,0);
   ...
   procedure Write_Fast_File(File : String; List : List_Of_Clauses) is
      ...
      function Term_To_Speed_Node( T : Term;
				   Tail, Nvars : Natural ) return Speed_Node is
	   S : Speed_Node;
   ...
   procedure Query(Question : Clause;
                   ...
                   Success   : out Boolean;
                   Solutions : out List_Of_Answers) is
       Succ : Boolean;
       L : List_Of_Answers;
       A : Solution;
       Q : Term;
   ...
   procedure Query(Question : Clause;
                   Based_On  : List_Of_Clauses;
                   Success   : out Boolean;
                   Bindings : out Answer) is  --  One single answer.
       S : Solution;
       Q : Term;
   begin
        Copy_Term(Question.Head, Q, Globalf);
