   ...
   loop
      begin
        ...
        case Op is
            ...
            when 4 => Put_Line ("Attribute : " & Attribute_Kind_Type'Image(
                                                Attribute_Kind (C(Getclause))));

            when 5 => Put_Line ("Integer : " & Integer'Image(
            ...
            when 13 => Put ("What kind of Append (CS-1,SC-2,SS-else) ? ");
                      Get (Op1);
                      case Op1 is
                          when 1 =>
                              Op2 := Getclause;
            ...
            when 43 => Put ("What kind of Append (LLi-1,LiL-2,LiLi-else) ? ");
                      Get (Op1);
                      case Op1 is
                          when 1 => 
                              Op2 := Get_List;
